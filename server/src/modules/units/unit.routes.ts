...
unitRoutes.get('/', authenticate, requireRoles('owner', 'cashier', 'employee'), listUnits);
unitRoutes.get('/:unitId', authenticate, requireRoles('owner', 'employee', 'cashier'), requireSameUnit(), getUnit);
