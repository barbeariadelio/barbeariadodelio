...
appointmentRoutes.patch('/:id/status', authenticate, requireRoles('owner', 'employee', 'franchisee', 'client', 'cashier'), updateAppointmentStatus);
appointmentRoutes.patch('/:id', authenticate, requireRoles('owner', 'employee', 'franchisee', 'client', 'cashier'), updateAppointment);
appointmentRoutes.delete('/:id', authenticate, requireRoles('owner', 'employee', 'franchisee', 'cashier'), deleteAppointment);
