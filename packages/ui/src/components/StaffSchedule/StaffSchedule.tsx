...
function WhatsAppModal({ appt, onClose, businessName = 'Barbearia' }: { appt: any, onClose: () => void, businessName?: string }) {
                    ...
                    {workingHours && (
                      <>
                        ...
                        {workingHours.lunchStart && workingHours.lunchEnd && !emp.workSchedule?.lunchStart && (
                          <div className={styles.lunchBreak} style={{ top: timeToTop(workingHours.lunchStart), height: timeToHeight(workingHours.lunchStart, workingHours.lunchEnd), pointerEvents: 'none' }}>
                            <span>ALMOÇO</span>
                          </div>
                        )}
                      </>
                    ...
                    {emp.workSchedule && (
                      <>
                        ...
                        {emp.workSchedule.lunchStart && emp.workSchedule.lunchEnd && (
                          <div className={styles.lunchBreak} style={{ top: timeToTop(emp.workSchedule.lunchStart), height: timeToHeight(emp.workSchedule.lunchStart, emp.workSchedule.lunchEnd), pointerEvents: 'none' }}>
                            <span>ALMOÇO</span>
                          </div>
                        )}
                      </>
